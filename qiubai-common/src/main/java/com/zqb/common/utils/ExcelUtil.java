                                ...
                                try {
                                    ...
                                    if (vo == null) {
                                        ...
                                        if (field.getType() == Date.class) {
                                            cell.setCellValue(field.get(vo) == null ? "" : String.valueOf(DateFormatUtils.format((Date) field.get(vo),DateUtils.YYYY_MM_DD_HH_MM_SS)));
                                        }
                                        if (field.getType() == LocalDateTime.class) {
                                            LocalDateTime localDateTime = (LocalDateTime) field.get(vo);
                                            String date = localDateTime.format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss"));
                                            cell.setCellValue(field.get(vo) == null ? "" : date);
                                        }
